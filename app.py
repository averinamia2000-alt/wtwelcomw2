...
async def question(message: Message):
    ...
    try:
        ...
        answer = (
            f"Поиск занял больше {REQUEST_TIMEOUT_SECONDS} секунд 😔 Попробуйте сформулировать вопрос чуть короче "
...
async def main():
    log.info(
        "Starting Whitech Helper v6.1; space=%s root=%s model=%s timeout=%ss",
